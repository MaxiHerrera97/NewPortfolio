        ...
        <section className="max-w-5xl px-4 md:px-6 mx-auto flex items-center h-16 md:h-20">
          ...
          <nav className="hidden md:flex md:flex-row md:items-center md:justify-end md:bg-transparent md:dark:bg-transparent md:backdrop-blur-none">
            <ul className="flex flex-row items-center gap-4 p-0 w-auto">
              <li><a href="#works" onClick={e => handleNavClick(e, 'works')} className="block px-3 py-2 md:py-1 rounded-lg font-medium transition-colors hover:bg-blue-500 dark:hover:bg-blue-900/40 hover:text-blue-700 dark:hover:text-blue-300">Trabajos</a></li>
              <li><a href="#skills" onClick={e => handleNavClick(e, 'skills')} className="block px-3 py-2 md:py-1 rounded-lg font-medium transition-colors hover:bg-blue-500 dark:hover:bg-blue-900/40 hover:text-blue-700 dark:hover:text-blue-300">Habilidades</a></li>
              <li><a href="#contact" onClick={e => handleNavClick(e, 'contact')} className="block px-3 py-2 md:py-1 rounded-lg font-medium transition-colors hover:bg-blue-500 dark:hover:bg-blue-900/40 hover:text-blue-700 dark:hover:text-blue-300">Contacto</a></li>
            </ul>
          </nav>
